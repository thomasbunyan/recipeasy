...
/* harmony import */ var _components_register_verify_verify_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/register/verify/verify.component */ "./src/app/components/register/verify/verify.component.ts");
...
/* harmony import */ var _components_results_results_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/results/results.component */ "./src/app/components/results/results.component.ts");
...
/* harmony import */ var _components_recommended_recommended_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/recommended/recommended.component */ "./src/app/components/recommended/recommended.component.ts");
...
/* harmony import */ var _components_recipe_recipe_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/recipe/recipe.component */ "./src/app/components/recipe/recipe.component.ts");
/* harmony import */ var _components_saved_cookbooks_cookbooks_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/saved-cookbooks/cookbooks.component */ "./src/app/components/saved-cookbooks/cookbooks.component.ts");
/* harmony import */ var _components_saved_recipes_saved_recipes_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/saved-recipes/saved-recipes.component */ "./src/app/components/saved-recipes/saved-recipes.component.ts");
/* harmony import */ var _components_cookbook_cookbook_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./components/cookbook/cookbook.component */ "./src/app/components/cookbook/cookbook.component.ts");
/* harmony import */ var _components_cookbook_edit_cookbook_dialog_edit_cookbook_dialog_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./components/cookbook/edit-cookbook-dialog/edit-cookbook-dialog.component */ "./src/app/components/cookbook/edit-cookbook-dialog/edit-cookbook-dialog.component.ts");
/* harmony import */ var _components_recipe_dialog_recipe_dialog_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./components/recipe-dialog/recipe-dialog.component */ "./src/app/components/recipe-dialog/recipe-dialog.component.ts");
/* harmony import */ var _components_create_ingredient_dialog_ingredient_dialog_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./components/create/ingredient-dialog/ingredient-dialog.component */ "./src/app/components/create/ingredient-dialog/ingredient-dialog.component.ts");
/* harmony import */ var _pipes_text_limit_pipe__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./pipes/text-limit.pipe */ "./src/app/pipes/text-limit.pipe.ts");
/* harmony import */ var _pipes_text_capitalise_pipe__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./pipes/text-capitalise.pipe */ "./src/app/pipes/text-capitalise.pipe.ts");
/* harmony import */ var _pipes_find_image_pipe__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./pipes/find-image.pipe */ "./src/app/pipes/find-image.pipe.ts");
...
/* harmony import */ var _services_user_validate_service__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./services/user-validate.service */ "./src/app/services/user-validate.service.ts");
...
/* harmony import */ var _services_recipe_validate_service__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./services/recipe-validate.service */ "./src/app/services/recipe-validate.service.ts");
/* harmony import */ var _services_recipe_service__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./services/recipe.service */ "./src/app/services/recipe.service.ts");
/* harmony import */ var _services_recipe_create_service__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./services/recipe-create.service */ "./src/app/services/recipe-create.service.ts");
/* harmony import */ var _services_cookbook_service__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./services/cookbook.service */ "./src/app/services/cookbook.service.ts");
/* harmony import */ var _components_sidenav_sidenav_service__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./components/sidenav/sidenav.service */ "./src/app/components/sidenav/sidenav.service.ts");
/* harmony import */ var _services_general_service__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./services/general.service */ "./src/app/services/general.service.ts");
/* harmony import */ var _components_recipe_dialog_recipe_dialog_service__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./components/recipe-dialog/recipe-dialog.service */ "./src/app/components/recipe-dialog/recipe-dialog.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    { path: "", component: _components_home_home_component__WEBPACK_IMPORTED_MODULE_12__["HomeComponent"], pathMatch: "full" },
    { path: "register", component: _components_register_register_component__WEBPACK_IMPORTED_MODULE_14__["RegisterComponent"] },
    { path: "verify", component: _components_register_verify_verify_component__WEBPACK_IMPORTED_MODULE_15__["VerifyComponent"] },
    { path: "login", component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_13__["LoginComponent"] },
    {
        path: "dashboard",
        component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_16__["DashboardComponent"],
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"]]
    },
    {
        path: "results",
        component: _components_results_results_component__WEBPACK_IMPORTED_MODULE_18__["ResultsComponent"],
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"]]
    },
    {
        path: "cookbooks",
        component: _components_saved_cookbooks_cookbooks_component__WEBPACK_IMPORTED_MODULE_23__["CookbooksComponent"],
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"]]
    },
    {
        path: "cookbook/:id",
        component: _components_cookbook_cookbook_component__WEBPACK_IMPORTED_MODULE_25__["CookbookComponent"],
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"]]
    },
    { path: "history", component: _components_history_history_component__WEBPACK_IMPORTED_MODULE_19__["HistoryComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"]] },
    { path: "recommended", component: _components_recommended_recommended_component__WEBPACK_IMPORTED_MODULE_20__["RecommendedComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"]] },
    { path: "profile", component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_17__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"]] },
    {
        path: "create",
        component: _components_create_create_component__WEBPACK_IMPORTED_MODULE_21__["CreateComponent"],
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"]]
    },
    {
        path: "recipes",
        component: _components_saved_recipes_saved_recipes_component__WEBPACK_IMPORTED_MODULE_24__["SavedRecipesComponent"],
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"]]
    },
    {
        path: "recipe/:id",
        component: _components_recipe_recipe_component__WEBPACK_IMPORTED_MODULE_22__["RecipeComponent"],
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"]]
    },
    { path: "**", redirectTo: "" }
];
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_results_results_component__WEBPACK_IMPORTED_MODULE_18__["ResultsComponent"],
                ...
                _components_cookbook_edit_cookbook_dialog_edit_cookbook_dialog_component__WEBPACK_IMPORTED_MODULE_26__["EditCookbookDialogComponent"],
                _components_recipe_dialog_recipe_dialog_component__WEBPACK_IMPORTED_MODULE_27__["RecipeDialogComponent"],
                _components_create_ingredient_dialog_ingredient_dialog_component__WEBPACK_IMPORTED_MODULE_28__["IngredientDialogComponent"],
                _components_saved_recipes_saved_recipes_component__WEBPACK_IMPORTED_MODULE_24__["SavedRecipesComponent"],
                _components_recipe_recipe_component__WEBPACK_IMPORTED_MODULE_22__["RecipeComponent"],
                _components_register_verify_verify_component__WEBPACK_IMPORTED_MODULE_15__["VerifyComponent"],
                _components_saved_cookbooks_cookbooks_component__WEBPACK_IMPORTED_MODULE_23__["CookbooksComponent"],
                _components_cookbook_cookbook_component__WEBPACK_IMPORTED_MODULE_25__["CookbookComponent"],
                _components_history_history_component__WEBPACK_IMPORTED_MODULE_19__["HistoryComponent"],
                _components_recommended_recommended_component__WEBPACK_IMPORTED_MODULE_20__["RecommendedComponent"],
                _pipes_text_limit_pipe__WEBPACK_IMPORTED_MODULE_29__["TextLimitPipe"],
                _pipes_text_capitalise_pipe__WEBPACK_IMPORTED_MODULE_30__["TextCapitalisePipe"],
                _pipes_find_image_pipe__WEBPACK_IMPORTED_MODULE_31__["FindImagePipe"]
            ],
            ...
            providers: [_services_user_validate_service__WEBPACK_IMPORTED_MODULE_34__["UserValidateService"], _services_recipe_validate_service__WEBPACK_IMPORTED_MODULE_36__["RecipeValidateService"], _components_sidenav_sidenav_service__WEBPACK_IMPORTED_MODULE_40__["SidenavService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_33__["AuthService"], _services_user_service__WEBPACK_IMPORTED_MODULE_35__["UserService"], _services_recipe_service__WEBPACK_IMPORTED_MODULE_37__["RecipeService"], _services_recipe_create_service__WEBPACK_IMPORTED_MODULE_38__["RecipeCreateService"], _services_cookbook_service__WEBPACK_IMPORTED_MODULE_39__["CookbookService"], _services_general_service__WEBPACK_IMPORTED_MODULE_41__["GeneralService"], _components_recipe_dialog_recipe_dialog_service__WEBPACK_IMPORTED_MODULE_42__["RecipeDialogService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_32__["AuthGuard"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["Title"]],
            bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_9__["AppComponent"]],
            entryComponents: [_components_cookbook_edit_cookbook_dialog_edit_cookbook_dialog_component__WEBPACK_IMPORTED_MODULE_26__["EditCookbookDialogComponent"], _components_recipe_dialog_recipe_dialog_component__WEBPACK_IMPORTED_MODULE_27__["RecipeDialogComponent"], _components_create_ingredient_dialog_ingredient_dialog_component__WEBPACK_IMPORTED_MODULE_28__["IngredientDialogComponent"]]
        })
    ], AppModule);
    return AppModule;
}());
...
var CookbookComponent = /** @class */ (function () {
    ...
    CookbookComponent.prototype.ngOnInit = function () {
        ...
        this.cookbookService.getCookBookById(this.cookbookId).subscribe(function (data) {
            if (!data.success) {
                ...
                if (JSON.parse(localStorage.getItem("user")).username === _this.cookbook.author) {
                    _this.owner = true;
                }
                else {
                    _this.owner = false;
...
module.exports = ".dashboard {\r\n  min-height: calc(100vh - 60px);\r\n  background-color: #f8f9fa;\r\n  /* background-color: #fff; */\r\n  padding-top: 1px;\r\n  width: 100%;\r\n  max-width: 1800px;\r\n  margin: auto;\r\n}\r\n\r\n/***  Welcome message ***/\r\n\r\n.welcomeMessage {\r\n  overflow: hidden;\r\n  padding-left: 60px;\r\n}\r\n\r\n.welcomeMessage label {\r\n  font-size: 35px;\r\n  font-weight: 900;\r\n}\r\n\r\n/***  Main window area ***/\r\n\r\n.wrapper {\r\n  width: 100%;\r\n  padding-bottom: 100px;\r\n}\r\n\r\n.breakLine {\r\n  width: 100%;\r\n  height: 2px;\r\n  background-color: #eaeaea;\r\n  border-radius: 25px;\r\n}\r\n\r\n/*** Categories ***/\r\n\r\n.categories {\r\n  width: 90%;\r\n  margin: 50px auto;\r\n  padding-bottom: 10px;\r\n  display: flex;\r\n  flex-direction: row;\r\n  /* justify-content: center; */\r\n  overflow: scroll;\r\n  overflow-y: hidden;\r\n}\r\n\r\n.categoryBox {\r\n  height: 80px;\r\n  min-width: 160px;\r\n  margin: 0 20px;\r\n  border-radius: 4px;\r\n  cursor: pointer;\r\n  background-color: #f1f1f5;\r\n  position: relative;\r\n}\r\n\r\n.categoryBox img {\r\n  height: 100%;\r\n  width: 100%;\r\n  -o-object-fit: cover;\r\n     object-fit: cover;\r\n  border-radius: 4px;\r\n}\r\n\r\n.catOverlay {\r\n  position: absolute;\r\n  top: 0;\r\n  left: 0;\r\n  border-radius: 4px;\r\n  height: 100%;\r\n  width: 100%;\r\n  background-color: rgba(27, 27, 27, 0.308);\r\n  color: #fff;\r\n  font-weight: bold;\r\n  font-size: 22px;\r\n  letter-spacing: 0.5px;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n  overflow: hidden;\r\n  pointer-events: none;\r\n  opacity: 0;\r\n  transition: all 0.2s ease-in-out;\r\n}\r\n\r\n.categoryBox:hover .catOverlay {\r\n  opacity: 1;\r\n  transition: all 0.2s ease-in-out;\r\n}\r\n\r\n.categories::-webkit-scrollbar {\r\n  height: 4px;\r\n}\r\n\r\n.categories::-webkit-scrollbar-thumb {\r\n  border-radius: 10px;\r\n  background-color: #ffffff00;\r\n}\r\n\r\n.categories:hover::-webkit-scrollbar-thumb {\r\n  background-color: #dadada;\r\n}\r\n\r\n/***  Top 'front' box ***/\r\n\r\n.front {\r\n  border-bottom: #eaeaea 1px solid;\r\n  width: 95%;\r\n  height: auto;\r\n  margin: 0 auto;\r\n  padding: 20px 0;\r\n}\r\n\r\n.front:nth-child(1) {\r\n  border-top: #eaeaea 1px solid;\r\n}\r\n\r\n.cookbookTitle p {\r\n  font-size: 14px;\r\n  color: rgb(88, 88, 88);\r\n}\r\n\r\n.topArea {\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  margin-bottom: 20px;\r\n}\r\n\r\n.topArea i {\r\n  cursor: pointer;\r\n}\r\n\r\n.boxContainer {\r\n  width: 100%;\r\n  display: flex;\r\n  flex-direction: row;\r\n  align-items: center;\r\n  overflow: hidden;\r\n}\r\n\r\n.itemBox {\r\n  margin-right: 20px;\r\n  width: 210px;\r\n}\r\n\r\n/*** Style for the image boxes ***/\r\n\r\n.cookbooks {\r\n  width: 100%;\r\n  margin: auto;\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n}\r\n\r\n.cookbook {\r\n  margin: 10px;\r\n  width: 10vw;\r\n  height: 10vw;\r\n  min-width: 170px;\r\n  min-height: 170px;\r\n  display: inline-block;\r\n  align-content: center;\r\n}\r\n\r\n.tImage {\r\n  width: 210px;\r\n  height: 210px;\r\n  margin: auto;\r\n  position: relative;\r\n  cursor: pointer;\r\n}\r\n\r\n.tPic {\r\n  width: 210px;\r\n  height: 210px;\r\n  border-radius: 25px;\r\n  background: #f1f1f5;\r\n}\r\n\r\n.tPic img {\r\n  height: 100%;\r\n  width: 100%;\r\n  -o-object-fit: cover;\r\n     object-fit: cover;\r\n  border-radius: 25px;\r\n}\r\n\r\n.tImageOverlay {\r\n  width: 100%;\r\n  height: 100%;\r\n  background-color: rgba(39, 39, 39, 0.6);\r\n  opacity: 0;\r\n  transition: all 0.3s ease-in-out 0s;\r\n  position: absolute;\r\n  z-index: 10;\r\n  top: 0;\r\n  left: 0;\r\n  border-radius: 25px;\r\n}\r\n\r\n.tImage:hover .tImageOverlay {\r\n  transition: all 0.3s ease-in-out 0s;\r\n  opacity: 1;\r\n}\r\n\r\n.tImageFav {\r\n  font-size: 24pt;\r\n  position: absolute;\r\n  top: 50%;\r\n  left: 50%;\r\n  -webkit-transform: translate(-50%, -50%);\r\n          transform: translate(-50%, -50%);\r\n  color: #fff;\r\n  cursor: default;\r\n}\r\n\r\n.tInfo {\r\n  padding: 10px 0 0 5px;\r\n  font-size: 10pt;\r\n  text-align: left;\r\n  font-family: \"ProductSansRegular\", sans-serif;\r\n  white-space: normal;\r\n}\r\n\r\n.tInfo-title {\r\n  display: inline-block;\r\n}\r\n\r\n.tInfo-title:hover {\r\n  text-decoration: underline;\r\n  cursor: pointer;\r\n}\r\n\r\n.tFol {\r\n  padding-top: 5px;\r\n  font-size: 9pt;\r\n}\r\n\r\n/*** Trending box ***/\r\n\r\n.recBox {\r\n  width: 95%;\r\n  margin: auto;\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  justify-content: center;\r\n  border-bottom: #eaeaea 1px solid;\r\n}\r\n\r\n.featuredRecipe {\r\n  min-height: 500px;\r\n  width: 750px;\r\n  padding: 0 30px;\r\n  margin: 0;\r\n  /* margin: auto; */\r\n  flex-grow: 1;\r\n  border-right: #eaeaea 1px solid;\r\n  overflow: hidden;\r\n  display: flex;\r\n  flex-direction: column;\r\n}\r\n\r\n/*** Search area ***/\r\n\r\n.searchArea {\r\n  /* margin: auto; */\r\n  width: 100%;\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  justify-content: center;\r\n  align-items: center;\r\n  margin-top: 50px;\r\n  /* margin-bottom: 50px; */\r\n  padding: 0 15px;\r\n}\r\n\r\n.searchArea i {\r\n  font-size: 20px;\r\n  margin-right: 10px;\r\n}\r\n\r\n.searchItem {\r\n  padding: 7px 12px;\r\n  margin: 5px 7px;\r\n  font-size: 14px;\r\n  border-radius: 25px;\r\n  font-weight: 500;\r\n  cursor: default;\r\n  background-color: #f1eff4;\r\n}\r\n\r\n.searchItem:hover {\r\n  text-decoration: underline;\r\n}\r\n\r\n.searchItem i {\r\n  margin-left: 5px;\r\n  cursor: pointer;\r\n}\r\n\r\n/*** Recipe scroll ***/\r\n\r\n.recipeScroll {\r\n  flex-grow: 1;\r\n  display: flex;\r\n  flex-direction: row;\r\n  /* justify-content: center; */\r\n  /* margin: 0 30px; */\r\n  padding-left: 250px;\r\n  box-sizing: border-box;\r\n  align-items: center;\r\n  overflow: hidden;\r\n  scroll-behavior: smooth;\r\n}\r\n\r\n.proMsg {\r\n  width: 100%;\r\n  text-align: right;\r\n  padding: 15px;\r\n  box-sizing: border-box;\r\n  color: rgb(107, 107, 107);\r\n}\r\n\r\n/*** Top table ***/\r\n\r\n.topRec {\r\n  height: 100%;\r\n  width: 450px;\r\n  padding: 20px;\r\n}\r\n\r\n.tableControls {\r\n  width: 100%;\r\n  margin: auto;\r\n  margin-top: 10px;\r\n  margin-bottom: 20px;\r\n  display: flex;\r\n  flex-direction: row;\r\n  align-items: center;\r\n  font-size: 20px;\r\n}\r\n\r\n.hotTopToggle {\r\n  display: flex;\r\n  flex-direction: row;\r\n}\r\n\r\n.httItem {\r\n  cursor: pointer;\r\n  transition: all 0.2s ease-in-out;\r\n}\r\n\r\n.httItem:nth-child(1) {\r\n  margin-right: 10px;\r\n  padding-right: 10px;\r\n  border-right: #cfcfcf 2px solid;\r\n}\r\n\r\n.hotSelected {\r\n  color: #ea5f1e;\r\n  transition: all 0.2s ease-in-out;\r\n}\r\n\r\n.topSelected {\r\n  color: #4286f5;\r\n  transition: all 0.2s ease-in-out;\r\n}\r\n\r\n/*** Drop down ***/\r\n\r\n.topLength {\r\n  opacity: 0;\r\n  transition: all 0.2s ease-in-out;\r\n  display: flex;\r\n  flex-direction: row;\r\n  align-items: center;\r\n  font-size: inherit;\r\n}\r\n\r\n.shown {\r\n  opacity: 1;\r\n  transition: all 0.2s ease-in-out;\r\n}\r\n\r\n.menu,\r\n.dropMenu {\r\n  list-style-type: none;\r\n  padding: 0;\r\n  margin: 0;\r\n  right: 0;\r\n  text-align: right;\r\n  background-color: #f8f9fa;\r\n}\r\n\r\n.menuItem {\r\n  position: relative;\r\n  text-decoration: none;\r\n  display: block;\r\n}\r\n\r\n.currentTime {\r\n  text-decoration: underline;\r\n  cursor: pointer;\r\n}\r\n\r\n.dropMenu {\r\n  display: none;\r\n  position: absolute;\r\n}\r\n\r\n.dropMenuItem {\r\n  color: #000;\r\n  cursor: pointer;\r\n}\r\n\r\n.dropMenuItem:hover {\r\n  color: #4286f5;\r\n}\r\n\r\n.showMenu {\r\n  display: block;\r\n}\r\n\r\n/*** Top recipe table ***/\r\n\r\n.topRec table {\r\n  display: inline-block;\r\n  font-family: inherit;\r\n  margin: auto;\r\n  background-color: rgba(255, 255, 255, 0);\r\n}\r\n\r\nth,\r\ntd {\r\n  vertical-align: middle;\r\n  transition: all 0.2s ease-in-out;\r\n  width: 945px;\r\n}\r\n\r\nth {\r\n  font-size: 13px;\r\n}\r\n\r\ntd {\r\n  font-size: 15px;\r\n}\r\n\r\n.elementRow:hover {\r\n  background-color: rgba(0, 0, 0, 0.1);\r\n  transition: all 0.2s ease-in-out;\r\n  cursor: pointer;\r\n}\r\n\r\n.topRow {\r\n  height: 100%;\r\n  width: 100%;\r\n  padding: 5px 0;\r\n  display: flex;\r\n  flex-direction: row;\r\n  align-items: center;\r\n  /* justify-content: center; */\r\n}\r\n\r\n.counter {\r\n  font-size: 20px;\r\n  margin-right: 10px;\r\n}\r\n\r\n.topRowImage {\r\n  height: 50px;\r\n  width: 50px;\r\n  margin-right: 10px;\r\n  border-radius: 8px;\r\n  background-color: #f1f1f5;\r\n}\r\n\r\n.topRowImage img {\r\n  height: 100%;\r\n  width: 100%;\r\n  -o-object-fit: cover;\r\n     object-fit: cover;\r\n  border-radius: 8px;\r\n}\r\n\r\n/**********************************************************************/\r\n\r\n/***  Featured box ***/\r\n\r\n.featured {\r\n  background-color: #fff;\r\n  border-radius: 8px;\r\n  box-shadow: 0 3px 4px 0 rgba(0, 0, 0, 0.09), 0 3px 3px -2px rgba(0, 0, 0, 0.12), 0 1px 8px 0 rgba(0, 0, 0, 0.08);\r\n  border: rgb(235, 235, 235) solid 1px;\r\n  padding: 20px;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n}\r\n\r\n/***  Trending box ***/\r\n\r\n.trending {\r\n  background-color: #fff;\r\n  border-radius: 8px;\r\n  box-shadow: 0 3px 4px 0 rgba(0, 0, 0, 0.09), 0 3px 3px -2px rgba(0, 0, 0, 0.12), 0 1px 8px 0 rgba(0, 0, 0, 0.08);\r\n  border: rgb(235, 235, 235) solid 1px;\r\n  padding: 20px;\r\n}\r\n\r\n.trending h3 {\r\n  margin-bottom: 10px;\r\n}\r\n\r\n.trendItem {\r\n  background-color: #f1f1f5;\r\n  color: #fff;\r\n  margin: 15px 0 0 0;\r\n  border-radius: 5px;\r\n  padding-top: 10px;\r\n  padding-left: 10px;\r\n  padding-right: 10px;\r\n  height: 55px;\r\n  text-align: center;\r\n  cursor: pointer;\r\n  display: flex;\r\n  position: relative;\r\n  box-shadow: 0 3px 15px rgba(0, 0, 0, 0.3);\r\n}\r\n\r\n.trendItem:hover {\r\n  background-color: #ff6e9e;\r\n}\r\n\r\n.trendItem:nth-child(1) {\r\n  background-color: #ea1e63;\r\n}\r\n\r\n.trendItem:nth-child(2) {\r\n  background-color: #4286f5;\r\n}\r\n\r\n.trendItem:nth-child(3) {\r\n  background-color: #8bc24a;\r\n}\r\n\r\n.trendItem:nth-child(4) {\r\n  background-color: #d177f6;\r\n}\r\n\r\n.trendItem:nth-child(5) {\r\n  background-color: #ff9700;\r\n}\r\n\r\n.trendInfo {\r\n  font-size: 14px;\r\n  text-align: left;\r\n}\r\n\r\n.trendInfo p {\r\n  font-size: 12px;\r\n}\r\n\r\n.trendAmount {\r\n  position: absolute;\r\n  bottom: 10px;\r\n  right: 10px;\r\n  font-size: 12px;\r\n}\r\n\r\n.hidden {\r\n  visibility: hidden;\r\n}\r\n\r\n/*** Discover more ***/\r\n\r\n/* .discoverMore {\r\n  background-color: blue;\r\n  margin: auto;\r\n  margin-top: 75px;\r\n  margin-bottom: 75px;\r\n  height: 40px;\r\n  width: 150px;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n} */\r\n\r\n.discoverMore {\r\n  margin: auto;\r\n  margin-top: 75px;\r\n  margin-bottom: 75px;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n}\r\n\r\n.moreRecipes {\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n}\r\n\r\n.recipeCard {\r\n  background-color: #fff;\r\n  min-width: 650px;\r\n  min-height: 450px;\r\n  height: 450px;\r\n  border-radius: 25px;\r\n  margin-right: 700px;\r\n  box-shadow: 0 3px 15px rgba(0, 0, 0, 0.1);\r\n  position: relative;\r\n}\r\n\r\n.mainImg {\r\n  height: 65%;\r\n  background-color: #f1f1f5;\r\n  border-top-left-radius: 25px;\r\n  border-top-right-radius: 25px;\r\n  cursor: pointer;\r\n}\r\n\r\n.mainImg img {\r\n  height: 100%;\r\n  width: 100%;\r\n  -o-object-fit: cover;\r\n     object-fit: cover;\r\n  border-top-left-radius: 25px;\r\n  border-top-right-radius: 25px;\r\n}\r\n\r\n.hidden {\r\n  visibility: hidden;\r\n}\r\n\r\n.rInfo {\r\n  height: 35%;\r\n  padding: 20px;\r\n  box-sizing: border-box;\r\n}\r\n\r\n.rTitle {\r\n  font-size: 20px;\r\n  font-weight: bold;\r\n  cursor: pointer;\r\n}\r\n\r\n.rDetails {\r\n  padding-top: 10px;\r\n  font-size: 14px;\r\n}\r\n\r\n.rDetails span {\r\n  color: #4286f5;\r\n}\r\n\r\n.rInteraction {\r\n  width: 100%;\r\n  position: absolute;\r\n  bottom: 20px;\r\n  left: 0;\r\n  padding: 0 20px;\r\n  box-sizing: border-box;\r\n  display: flex;\r\n  justify-content: space-around;\r\n  align-items: center;\r\n  font-size: 18px;\r\n}\r\n\r\n.interactionButtons i {\r\n  margin: 0 9px;\r\n  font-size: 18px;\r\n  cursor: pointer;\r\n}\r\n\r\n/***  General code ***/\r\n\r\n.wide {\r\n  grid-column: 1/5;\r\n}\r\n\r\n.med {\r\n  grid-column: 1/4;\r\n}\r\n\r\n.saved {\r\n  color: #df2064;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "/******* Global *******/\r\n.home {\r\n  /******* Vars *******/\r\n  --main-text: #555555;\r\n  --main-dark-text: #363636;\r\n  --main-light-text: #696c80;\r\n  --light-background: #e7e7e7;\r\n  --button-color: #4286f5;\r\n  --circle: #e7e7e7;\r\n  --circle-top: #6d6d6d;\r\n  --circle-bottom: #c5c5c5;\r\n\r\n  min-height: 100%;\r\n  max-width: 100vw;\r\n  background-color: #fff;\r\n  color: var(--main-text);\r\n  overflow: hidden;\r\n  z-index: -2;\r\n}\r\n.wrapper {\r\n  width: 100%;\r\n  position: relative;\r\n  margin: auto;\r\n  z-index: 2;\r\n  color: var(--main-text);\r\n  overflow: hidden;\r\n}\r\n/*** ***/\r\n.initialScreen {\r\n  z-index: 1;\r\n  position: absolute;\r\n  width: 100vw;\r\n  height: 100vh;\r\n}\r\n/******* Nav *******/\r\nnav {\r\n  width: 80%;\r\n  margin: auto;\r\n  margin-top: 58px;\r\n  overflow: hidden;\r\n  z-index: 100 !important;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n}\r\na {\r\n  text-decoration: none;\r\n  color: var(--main-text);\r\n  font-size: 18px;\r\n  font-weight: 300;\r\n  margin: 0 10px;\r\n}\r\n.navLeft {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n}\r\n.navRight {\r\n  display: flex;\r\n  align-items: center;\r\n  /* margin-right: -10px; */\r\n}\r\n.logo {\r\n  padding: 0;\r\n  font-size: 32px;\r\n  font-weight: 900;\r\n  margin-right: 30px;\r\n}\r\n.subPoint {\r\n  padding: 0;\r\n  font-size: 17px;\r\n  margin-left: 25px;\r\n  /* font-weight: 900; */\r\n}\r\n.btnSmall {\r\n  color: var(--button-color);\r\n  border: var(--button-color) 2px solid;\r\n  border-radius: 5px;\r\n  font-size: 17px;\r\n  padding: 0.6em 1.4em;\r\n  text-align: center;\r\n  transition: 0.15s all ease-in-out;\r\n}\r\n.btnSmall:hover {\r\n  color: #fff;\r\n  background-color: var(--button-color);\r\n  transition: 0.15s all ease-in-out;\r\n}\r\n/******* Landing *******/\r\n.landingArea {\r\n  margin: auto;\r\n  /* background-color: red; */\r\n  margin-top: 170px;\r\n  max-width: 1170px;\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: flex-start;\r\n  flex-wrap: wrap;\r\n  /* background-color: red; */\r\n}\r\n.landingLeft {\r\n  /* margin: auto; */\r\n}\r\n.landingRight {\r\n  /* margin: auto; */\r\n}\r\n.slogan {\r\n  /* margin: 0 10px; */\r\n}\r\n.slogan h1 {\r\n  margin: 0 auto;\r\n  font-size: 60px;\r\n  overflow: hidden;\r\n  white-space: normal;\r\n}\r\n.slogan p {\r\n  font-size: 17px;\r\n  max-width: 450px;\r\n  padding: 20px 0;\r\n  /* white-space: pre-wrap; */\r\n}\r\n.continue {\r\n  display: flex;\r\n  flex-direction: row;\r\n  align-items: center;\r\n}\r\n.btnMed {\r\n  color: #fff;\r\n  background-color: var(--button-color);\r\n  border-radius: 5px;\r\n  padding: 1.15em 2.3em;\r\n  text-align: center;\r\n  font-size: 17px;\r\n  transition: 0.15s all ease-in-out;\r\n}\r\n.moreLink {\r\n  margin-left: 50px;\r\n  text-align: center;\r\n  font-size: 16px;\r\n}\r\n.btnMed:hover {\r\n  background-color: rgb(63, 0, 158);\r\n  transition: 0.15s all ease-in-out;\r\n}\r\n.gifArea {\r\n  margin: auto;\r\n  height: 500px;\r\n  width: 500px;\r\n  overflow: hidden;\r\n}\r\n.imageBox {\r\n  margin: 0;\r\n  height: 500px;\r\n  min-width: 500px;\r\n  /* background-color: rgba(0, 0, 0, 0.274); */\r\n}\r\n.imageBox img {\r\n  max-width: 100%;\r\n  max-height: 100%;\r\n  -o-object-fit: contain;\r\n     object-fit: contain;\r\n}\r\n.imageBoxContainer {\r\n  margin: auto;\r\n  height: 500px;\r\n  width: 500px;\r\n  display: flex;\r\n  flex-direction: row;\r\n  -webkit-animation: slideShow 8.5s ease-in-out 0s infinite;\r\n          animation: slideShow 8.5s ease-in-out 0s infinite;\r\n}\r\n@-webkit-keyframes slideShow {\r\n  10% {\r\n    -webkit-transform: translateX(0);\r\n            transform: translateX(0);\r\n  }\r\n  15%,\r\n  45% {\r\n    -webkit-transform: translateX(-500px);\r\n            transform: translateX(-500px);\r\n  }\r\n  50%,\r\n  80% {\r\n    -webkit-transform: translateX(-1000px);\r\n            transform: translateX(-1000px);\r\n  }\r\n  85%,\r\n  100% {\r\n    -webkit-transform: translateX(-1500px);\r\n            transform: translateX(-1500px);\r\n  }\r\n}\r\n@keyframes slideShow {\r\n  10% {\r\n    -webkit-transform: translateX(0);\r\n            transform: translateX(0);\r\n  }\r\n  15%,\r\n  45% {\r\n    -webkit-transform: translateX(-500px);\r\n            transform: translateX(-500px);\r\n  }\r\n  50%,\r\n  80% {\r\n    -webkit-transform: translateX(-1000px);\r\n            transform: translateX(-1000px);\r\n  }\r\n  85%,\r\n  100% {\r\n    -webkit-transform: translateX(-1500px);\r\n            transform: translateX(-1500px);\r\n  }\r\n}\r\n/******* Screenshot *******/\r\n.imageBackground {\r\n  width: 100vw;\r\n  position: relative;\r\n  overflow: hidden;\r\n  display: flex;\r\n}\r\n.imageBackground img {\r\n  z-index: -1;\r\n  width: 100%;\r\n  min-width: 1000px;\r\n  height: 100%;\r\n  position: absolute;\r\n}\r\n.screenShot {\r\n  position: relative;\r\n  margin: 70px auto;\r\n  overflow: auto;\r\n  z-index: 100 !important;\r\n  overflow: hidden;\r\n}\r\n.screenShot img {\r\n  position: relative;\r\n  max-width: 1150px;\r\n}\r\n/*** Affiliates ***/\r\n.affiliates {\r\n  width: 100%;\r\n  height: 180px;\r\n  background-color: #f2f2f2;\r\n}\r\n.affRow {\r\n  display: flex;\r\n  flex-direction: row;\r\n  justify-content: space-evenly;\r\n  align-items: center;\r\n  margin: auto;\r\n  width: 1170px;\r\n  height: 100%;\r\n}\r\n/******* More info *******/\r\n.moreInfo {\r\n  margin: auto;\r\n  margin-top: 150px;\r\n  margin-bottom: 150px;\r\n  max-width: 1170px;\r\n}\r\n.column {\r\n  display: flex;\r\n  flex-direction: column;\r\n}\r\n.row {\r\n  display: flex;\r\n  flex-direction: row;\r\n  justify-content: space-evenly;\r\n  align-items: center;\r\n  flex-wrap: wrap;\r\n  margin: 75px 0;\r\n}\r\n.infoBox {\r\n  width: 470px;\r\n  font-size: 16px;\r\n  font-weight: normal;\r\n}\r\n.infoBox i {\r\n  font-size: 20px;\r\n  padding-bottom: 10px;\r\n}\r\n.infoBox h2 {\r\n  font-size: 30px;\r\n  font-weight: normal;\r\n  padding-bottom: 10px;\r\n}\r\n.infoBox p {\r\n  padding-bottom: 15px;\r\n  padding-right: 25px;\r\n}\r\n/******* Mobile area *******/\r\n.mobileArea {\r\n  background-color: #03a9f5;\r\n  width: 100%;\r\n  height: 750px;\r\n  text-align: center;\r\n  color: #fff;\r\n  margin-bottom: 150px;\r\n}\r\n.mobileArea h2 {\r\n  padding-top: 3%;\r\n  padding-bottom: 1%;\r\n  font-size: 50px;\r\n  font-weight: normal;\r\n}\r\n.phone {\r\n  height: 635px;\r\n  width: 340px;\r\n  border-radius: 15px;\r\n  background-color: #efefef;\r\n  margin: 75px auto;\r\n  box-shadow: 0px 5px 25px 0px rgba(63, 71, 102, 0.5);\r\n}\r\n/******* Spaced Area *******/\r\n.spacedArea {\r\n  overflow: hidden;\r\n}\r\n.breakerBar {\r\n  height: 200px;\r\n  width: 18px;\r\n  background-color: #e8e8e8;\r\n  border-radius: 25px;\r\n  margin: auto;\r\n  margin-top: 50px;\r\n  margin-bottom: 50px;\r\n}\r\n.infoPanel {\r\n  width: 60%;\r\n  height: 350px;\r\n  margin: auto;\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  font-size: 17px;\r\n}\r\n.infoPanelL {\r\n  width: 50%;\r\n  font-size: 17px;\r\n}\r\n.infoPanelR {\r\n  width: 50%;\r\n  padding-left: 100px;\r\n}\r\n.infoPanelR h2 {\r\n  width: 80%;\r\n  font-size: 50px;\r\n  font-weight: normal;\r\n  padding-bottom: 10px;\r\n}\r\n.infoPanelR p {\r\n  width: 80%;\r\n}\r\n.infoPanelS {\r\n  height: 350px;\r\n  width: 600px;\r\n  border-radius: 25px;\r\n  float: left;\r\n  background-color: #adadad;\r\n}\r\n/******* More *******/\r\n.more {\r\n  width: 70%;\r\n  margin: auto;\r\n  display: flex;\r\n  justify-content: space-around;\r\n  align-items: center;\r\n}\r\n.feature {\r\n  --feature-color1: #d177f6;\r\n  --feature-color2: #fed15a;\r\n  --feature-color3: #00bcd5;\r\n  width: 350px;\r\n  background-color: #fff;\r\n  box-shadow: 0px 5px 25px 0px rgba(63, 71, 102, 0.25);\r\n  padding: 85px 30px 90px 30px;\r\n  font-size: 17px;\r\n  text-align: center;\r\n  border-bottom-right-radius: 15px;\r\n  border-bottom-left-radius: 15px;\r\n}\r\n.feature i {\r\n  padding-bottom: 30px;\r\n  font-size: 55px;\r\n}\r\n.feature h2 {\r\n  font-weight: normal;\r\n  font-size: 30px;\r\n}\r\n.feature p {\r\n  width: 90%;\r\n  padding-top: 30px;\r\n  margin: auto;\r\n  color: #9498b8;\r\n}\r\n#feature-1 {\r\n  border-top: 5px solid var(--feature-color1);\r\n}\r\n#feature-1 i {\r\n  color: var(--feature-color1);\r\n}\r\n#feature-2 {\r\n  border-top: 5px solid var(--feature-color2);\r\n}\r\n#feature-2 i {\r\n  color: var(--feature-color2);\r\n}\r\n#feature-3 {\r\n  border-top: 5px solid var(--feature-color3);\r\n}\r\n#feature-3 i {\r\n  color: var(--feature-color3);\r\n}\r\n/******* Image Bar *******/\r\n.image-bar {\r\n  margin-top: 300px;\r\n  height: 400px;\r\n  width: 100%;\r\n  position: relative;\r\n  background-color: #f6f6f6;\r\n}\r\n.about {\r\n  width: 50%;\r\n  height: 70%;\r\n  position: absolute;\r\n  left: 50%;\r\n  top: 50%;\r\n  -webkit-transform: translate(-50%, -50%);\r\n          transform: translate(-50%, -50%);\r\n  background-color: #fff;\r\n  box-shadow: 0px 5px 25px 0px rgba(63, 71, 102, 0.25);\r\n  border-radius: 8px;\r\n  display: flex;\r\n  justify-content: space-around;\r\n}\r\n.profile-text {\r\n  background-color: #fff;\r\n  width: 100px;\r\n  padding: 6% 15% 6% 15%;\r\n  flex: 1;\r\n  border-radius: 15px;\r\n  font-size: 17px;\r\n}\r\n.profile-text h2 {\r\n  font-weight: normal;\r\n  padding-bottom: 10px;\r\n  font-size: 30px;\r\n}\r\n.profile-image {\r\n  width: 280px;\r\n  height: 280px;\r\n  -webkit-transform: scale(1.1);\r\n          transform: scale(1.1);\r\n  background-color: #adadad;\r\n  box-shadow: 0px 5px 25px 0px rgba(63, 71, 102, 0.25);\r\n  border-radius: 8px;\r\n}\r\n.profile-image img {\r\n  border-radius: 8px;\r\n}\r\n/******* Bottom *******/\r\n.bottomArea {\r\n  height: 80vh;\r\n  width: 100%;\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  align-items: center;\r\n}\r\n.bottomArea h1 {\r\n  font-weight: normal;\r\n  font-size: 50px;\r\n}\r\n.bottomArea a {\r\n  margin-top: 25px;\r\n  font-size: 17px;\r\n  padding: 18px 40px;\r\n  color: #fff;\r\n  border-radius: 30px;\r\n  background-color: #4286f5;\r\n  transition: 0.15s all ease-in-out;\r\n  cursor: pointer;\r\n}\r\n.bottomArea a:hover {\r\n  background-color: #7aadff;\r\n  transition: 0.15s all ease-in-out;\r\n}\r\n/******* Footer *******/\r\nfooter {\r\n  padding-bottom: 50px;\r\n  width: 72%;\r\n  margin: auto;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n}\r\n.logoB {\r\n  font-size: 32px;\r\n  font-weight: 900;\r\n  margin-right: 50px;\r\n}\r\n/******* Other *******/\r\n/* !REMOVE THIS */\r\n/* Logged in page. */\r\n.card {\r\n  background-color: #fff;\r\n  /* border: 1px solid #dadce0; */\r\n  border-radius: 8px;\r\n  padding: 20px;\r\n  transition: all 0.1s ease-in-out;\r\n  box-shadow: 0 0 2rem rgba(0, 0, 99, 0.1);\r\n}\r\n.card:hover {\r\n  /* box-shadow: 0 2px 5px rgba(0, 0, 0, 0.3);\r\n  box-shadow: 0 6px 0 0 rgba(0, 0, 0, 0.01), 0 15px 32px 0 rgba(0, 0, 0, 0.06); */\r\n\r\n  transition: all 0.1s ease-in-out;\r\n}\r\n.search-bar {\r\n  width: 100%;\r\n  padding: 20px;\r\n  overflow: hidden;\r\n}\r\n.search {\r\n  border-radius: 25px;\r\n  background-color: #fff;\r\n  padding: 20px;\r\n}\r\n.input-field {\r\n  font-family: inherit;\r\n  flex-grow: 1;\r\n  resize: none;\r\n  font-size: 16px;\r\n  width: 400px;\r\n  font-weight: 200;\r\n  padding: 10px 10px;\r\n}\r\n.picked {\r\n  width: 100%;\r\n  margin: auto;\r\n}\r\n.picked-card {\r\n  padding: 10px;\r\n  margin: 20px;\r\n}\r\n.cookbookTitle {\r\n  margin: auto;\r\n  text-align: left;\r\n  font-family: \"ProductSansRegular\", sans-serif;\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  padding-left: 10px;\r\n}\r\n.tTitle {\r\n  font-size: 14pt;\r\n}\r\n.tNav {\r\n}\r\n.cookbooks {\r\n  width: 100%;\r\n  margin: auto;\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n}\r\n.cookbook {\r\n  margin: 10px;\r\n  width: 10vw;\r\n  height: 10vw;\r\n  min-width: 170px;\r\n  min-height: 170px;\r\n  display: inline-block;\r\n  align-content: center;\r\n}\r\n.tImage {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: relative;\r\n  cursor: pointer;\r\n}\r\n.tPic {\r\n  width: 100%;\r\n  height: 100%;\r\n  border-radius: 8px;\r\n  background: #f953c6; /* fallback for old browsers */ /* Chrome 10-25, Safari 5.1-6 */\r\n  background: linear-gradient(to right, #b91d73, #f953c6); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */\r\n}\r\n.tImageOverlay {\r\n  width: 100%;\r\n  height: 100%;\r\n  background-color: rgba(39, 39, 39, 0.6);\r\n  opacity: 0;\r\n  transition: all 0.3s ease-in-out 0s;\r\n  position: absolute;\r\n  z-index: 10;\r\n  top: 0;\r\n  left: 0;\r\n  border-radius: 8px;\r\n}\r\n.tImage:hover .tImageOverlay {\r\n  transition: all 0.3s ease-in-out 0s;\r\n  opacity: 1;\r\n}\r\n.tImageFav {\r\n  font-size: 24pt;\r\n  position: absolute;\r\n  top: 50%;\r\n  left: 50%;\r\n  -webkit-transform: translate(-50%, -50%);\r\n          transform: translate(-50%, -50%);\r\n  color: #fff;\r\n  cursor: default;\r\n}\r\n.tInfo {\r\n  width: 100%;\r\n  padding-top: 5px;\r\n  font-size: 10pt;\r\n  margin: auto;\r\n  text-align: left;\r\n  font-family: \"ProductSansRegular\", sans-serif;\r\n  white-space: normal;\r\n}\r\n.tInfo-title {\r\n  display: inline-block;\r\n}\r\n.tInfo-title:hover {\r\n  text-decoration: underline;\r\n  cursor: pointer;\r\n}\r\n.tFol {\r\n  padding-top: 5px;\r\n  font-size: 9pt;\r\n}\r\n.unclickable,\r\n.unclickable:hover {\r\n  color: rgba(82, 82, 82, 0.445);\r\n  cursor: default !important;\r\n}\r\n.dash-area {\r\n  display: flex;\r\n  align-content: flex-start;\r\n  justify-content: flex-start;\r\n  flex-wrap: wrap;\r\n}\r\n.info {\r\n  flex-grow: 1;\r\n  min-width: 400px;\r\n  height: 400px;\r\n  margin: 20px;\r\n}\r\n.trending {\r\n  width: 375px;\r\n  min-height: 10px;\r\n  margin: 20px;\r\n  display: flex;\r\n  flex-direction: column;\r\n  flex-wrap: nowrap;\r\n  justify-content: flex-start;\r\n  align-items: center;\r\n}\r\n.trending-title {\r\n  padding: 10px;\r\n}\r\n.trending-recipe {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  height: 40px;\r\n  width: 90%;\r\n  border-radius: 3px;\r\n  margin-top: 5px;\r\n  text-align: center;\r\n  background-color: rgba(0, 0, 0, 0.075);\r\n}\r\n.trending-recipe:hover {\r\n  background-color: rgba(0, 0, 0, 0.253);\r\n  cursor: pointer;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<div class=\"home\">\r\n  <div class=\"wrapper\">\r\n    <nav id=\"nav\">\r\n      <div class=\"navLeft\"><a href=\"/\" class=\"logo\"># Recipeasy</a></div>\r\n      <div class=\"navRight\">\r\n        <a href=\"#\" class=\"subPoint\">About</a>\r\n        <a href=\"#\" class=\"subPoint\">Features</a> <a href=\"#\" class=\"subPoint\">Contact</a>\r\n        <a class=\"subPoint btnSmall\" [routerLinkActive]=\"['active']\" [routerLink]=\"['/login']\">Login</a>\r\n      </div>\r\n    </nav>\r\n    <div class=\"landingArea\">\r\n      <div class=\"landingLeft\">\r\n        <div class=\"slogan\">\r\n          <h1>Recipes made easy.</h1>\r\n          <p>Some text in gdlkn hrte to fil thr ganm fdkd fpfkdjsedsjekljs sldfjlskd but that osnt mesan hthat I can t. Some text in gdlkn hrte to fil thr ganm fdkd fpfkdjsedsjekljs.</p>\r\n          <div class=\"continue\">\r\n            <a [routerLinkActive]=\"['active']\" [routerLink]=\"['/register']\" class=\"btnMed\">Register now</a>\r\n            <a class=\"moreLink\" href=\"#\">Learn More</a>\r\n          </div>\r\n        </div>\r\n      </div>\r\n      <div class=\"landingRight\">\r\n        <div class=\"gifArea\">\r\n          <div class=\"imageBoxContainer\">\r\n            <div class=\"imageBox\"><img src=\"../../../assets//images/icecream@2x.png\" /></div>\r\n            <div class=\"imageBox\"><img src=\"../../../assets//images/icecream@2x.png\" /></div>\r\n            <div class=\"imageBox\"><img src=\"../../../assets//images/icecream@2x.png\" /></div>\r\n            <div class=\"imageBox\"><img src=\"../../../assets//images/icecream@2x.png\" /></div>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"imageBackground\">\r\n      <img src=\"../../../assets/images/Path 11.svg\" />\r\n      <div class=\"screenShot\">\r\n        <img src=\"../../../assets/images/Group 16@2x.png\" />\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <div class=\"affiliates\">\r\n    <div class=\"affRow\">\r\n      <div class=\"affiliate\">One</div>\r\n      <div class=\"affiliate\">Two</div>\r\n      <div class=\"affiliate\">Three</div>\r\n    </div>\r\n  </div>\r\n  <div class=\"moreInfo\">\r\n    <div class=\"column\">\r\n      <div class=\"row\">\r\n        <div class=\"infoBox\">\r\n          <i class=\"fas fa-book\" style=\"color: #FF9700\"></i>\r\n          <h2>An archive of recipes</h2>\r\n          <p>mply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>\r\n          <p>mply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>\r\n        </div>\r\n        <div class=\"infoBox\">\r\n          <i class=\"fas fa-desktop\" style=\"color: #EA1E63\"></i>\r\n          <h2>Multi-Browser support</h2>\r\n          <p>mply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>\r\n          <p>mply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>\r\n        </div>\r\n      </div>\r\n      <div class=\"row\">\r\n        <div class=\"infoBox\">\r\n          <i class=\"fas fa-save\" style=\"color: #8BC24A\"></i>\r\n          <h2>Save them for later</h2>\r\n          <p>mply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>\r\n          <p>mply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>\r\n        </div>\r\n        <div class=\"infoBox\">\r\n          <i class=\"fas fa-edit\" style=\"color: #673BB7\"></i>\r\n          <h2>Edit your own</h2>\r\n          <p>mply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>\r\n          <p>mply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <div class=\"mobileArea\">\r\n    <h2>Go Mobile</h2>\r\n    <p>Explore recipes anywhere</p>\r\n    <div class=\"phone\"></div>\r\n  </div>\r\n  <!-- <div class=\"spacedArea\">\r\n    <div class=\"breakerBar\"></div>\r\n    <div class=\"infoPanel\">\r\n      <div class=\"infoPanelR\">\r\n        <h2>Create your own</h2>\r\n        <p>mply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>\r\n      </div>\r\n      <div class=\"infoPanelL\"><div class=\"infoPanelS\"></div></div>\r\n    </div>\r\n    <div class=\"breakerBar\"></div>\r\n    <div class=\"infoPanel\">\r\n      <div class=\"infoPanelL\"><div class=\"infoPanelS\" style=\"float: right;\"></div></div>\r\n      <div class=\"infoPanelR\" style=\"text-align: right;\">\r\n        <h2>Share with others</h2>\r\n        <p>mply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>\r\n      </div>\r\n    </div>\r\n    <div class=\"breakerBar\"></div>\r\n  </div>\r\n  <div class=\"more\">\r\n    <div class=\"feature\" id=\"feature-1\">\r\n      <i class=\"fas fa-money-bill-wave\"></i>\r\n      <h2>Headline</h2>\r\n      <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Error corrupti quaerat aspernatur.</p>\r\n    </div>\r\n    <div class=\"feature\" id=\"feature-2\">\r\n      <i class=\"fas fa-cookie-bite\"></i>\r\n      <h2>Headline</h2>\r\n      <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Error corrupti quaerat aspernatur.</p>\r\n    </div>\r\n    <div class=\"feature\" id=\"feature-3\">\r\n      <i class=\"fas fa-search\"></i>\r\n      <h2>Headline</h2>\r\n      <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Error corrupti quaerat aspernatur.</p>\r\n    </div>\r\n  </div> -->\r\n  <!-- <div class=\"image-bar\">\r\n    <div class=\"about\">\r\n      <div class=\"profile-text\">\r\n        <h2>Professionals love it</h2>\r\n        <p>\r\n          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione aliquid, molestias velit iusto dolor neque. Commodi, consectetur. Tenetur facilis in, omnis animi maxime vero quod possimus dolore nihil\r\n          distinctio. Veritatis.\r\n        </p>\r\n      </div>\r\n      <div class=\"profile-image\"><img src=\"https://picsum.photos/300/300/?random\" height=\"100%\" width=\"100%\" /></div>\r\n    </div>\r\n  </div> -->\r\n  <div class=\"bottomArea\">\r\n    <h1>What are you waiting for?</h1>\r\n    <a [routerLinkActive]=\"['active']\" [routerLink]=\"['/register']\" href=\"#\" class=\"startedButton\">Get started</a>\r\n  </div>\r\n  <footer>\r\n    <div class=\"navLeft\"><a href=\"#\" class=\"logoB\">Recipeasy</a> <a href=\"#\" class=\"subPoint\">Privacy and Terms</a> <a href=\"#\" class=\"subPoint\">About Recipeasy</a></div>\r\n    <div class=\"navRight\">\r\n      <a href=\"#\" class=\"subPoint\"><i class=\"far fa-question-circle\" style=\"padding-right: 5px;\"></i>Help</a>\r\n    </div>\r\n  </footer>\r\n</div>\r\n"
...
module.exports = "<!-- <div class=\"login\">\r\n  <div *ngIf=\"!forgot\" class=\"login-form\">\r\n    <h1 class=\"login-title\">Log in</h1>\r\n    <input class=\"input-field\" id=\"usernameField\" type=\"text\" [(ngModel)]=\"username\" name=\"username\" placeholder=\"username\" />\r\n    <input class=\"input-field\" id=\"passwordField\" type=\"password\" [(ngModel)]=\"password\" name=\"password\" placeholder=\"password\" />\r\n    <div *ngIf=\"error\" class=\"errorMessage\">\r\n      <p>{{ errorMessage }}</p>\r\n    </div>\r\n    <button mat-stroked-button class=\"login-button\" (click)=\"onLoginSubmit()\">Log in</button>\r\n    <a class=\"forgot-button\" (click)=\"forgotPw()\">Forgot your username or password?</a> <a class=\"forgot-button\" [routerLinkActive]=\"['active']\" [routerLink]=\"['/login']\">Don't have an account? login!</a>\r\n  </div>\r\n\r\n  <div *ngIf=\"forgot\" class=\"login-form\">\r\n    <h1 class=\"login-title\">Recover</h1>\r\n    <input class=\"input-field\" type=\"text\" [(ngModel)]=\"recovery\" name=\"recovery\" placeholder=\"email or username\" /> <button mat-stroked-button class=\"login-button\" (click)=\"onRecoverSubmit()\">Send recovery</button>\r\n    <a class=\"forgot-button\" (click)=\"forgotPw()\">Go back.</a>\r\n  </div>\r\n</div> -->\r\n\r\n<div class=\"login\">\r\n  <nav id=\"nav\">\r\n    <div class=\"navLeft\"><a href=\"#\" class=\"logo\">Recipeasy</a> <a href=\"#\" class=\"subPoint\">About</a> <a href=\"#\" class=\"subPoint\">How it works</a> <a href=\"#\" class=\"subPoint\">Contact</a></div>\r\n    <div class=\"navRight\"><a class=\"subPoint\" [routerLinkActive]=\"['active']\" [routerLink]=\"['/login']\">Register</a></div>\r\n  </nav>\r\n  <div class=\"content-area\">\r\n    <div class=\"loginForm\" [ngClass]=\"{ show: !forgot }\">\r\n      <h1>Log in</h1>\r\n      <form autocomplete=\"off\">\r\n        <div class=\"input-col\">\r\n          <input type=\"text\" [(ngModel)]=\"username\" name=\"username\" class=\"input-field\" placeholder=\"Username\" />\r\n        </div>\r\n        <div class=\"input-col\">\r\n          <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" class=\"input-field\" placeholder=\"Password\" autocomplete=\"password\" />\r\n        </div>\r\n        <div class=\"errorMessage\">\r\n          <p>{{ errorMessage }}</p>\r\n        </div>\r\n        <input class=\"loginButton\" (click)=\"onLoginSubmit()\" type=\"button\" value=\"Log in\" />\r\n        <a class=\"forgot-button\" (click)=\"forgot = !forgot\">Forgot your username or password?</a>\r\n        <a class=\"forgot-button\" [routerLink]=\"['/register']\">Don't have an account? Register!</a>\r\n      </form>\r\n    </div>\r\n    <div class=\"loginForm\" [ngClass]=\"{ show: forgot }\">\r\n      <h1 class=\"login-title\">Recover</h1>\r\n      <input class=\"input-field forgotInput\" type=\"text\" [(ngModel)]=\"recovery\" name=\"recovery\" placeholder=\"Email\" />\r\n      <input class=\"loginButton\" (click)=\"onRecoverSubmit()\" type=\"button\" value=\"Send recovery\" />\r\n      <a class=\"forgot-button\" (click)=\"forgot = !forgot\">Go back.</a>\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
module.exports = ".navbar {\r\n  width: 100%;\r\n  height: 59px;\r\n  background-color: #fff;\r\n  color: #000;\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  overflow: hidden;\r\n  border-bottom: #e2e2e2 1px solid;\r\n}\r\n\r\n/*** Button to toggle sidebar ***/\r\n\r\n.sidebarToggle {\r\n  font-size: 16pt;\r\n  z-index: 1;\r\n}\r\n\r\n.sideToggle {\r\n  cursor: pointer;\r\n}\r\n\r\n.sideGraphic {\r\n  background-color: #192b4000;\r\n  width: 300px;\r\n  height: 100%;\r\n  transition: all 0.275s ease-out 0s;\r\n  position: absolute;\r\n  align-self: flex-start;\r\n}\r\n\r\n.wideGraphic {\r\n  width: 0px;\r\n  transition: all 0.25s ease-out 0s;\r\n}\r\n\r\n/*** Logo area ***/\r\n\r\n.leftNav {\r\n  display: flex;\r\n  /* background-color: #4286f5; */\r\n  height: 100%;\r\n  padding: 0 50px;\r\n  align-items: center;\r\n  justify-content: space-evenly;\r\n}\r\n\r\n.logoArea {\r\n  font-family: \"ProductSansRegular\", sans-serif;\r\n}\r\n\r\n.logo {\r\n  font-size: 22pt;\r\n  font-weight: bold;\r\n  cursor: pointer;\r\n  color: #000;\r\n}\r\n\r\n.logoContainer {\r\n  display: table-cell;\r\n  vertical-align: middle;\r\n  opacity: 1;\r\n  transition: all 0.2s ease-out 0.2s;\r\n}\r\n\r\n.hidden {\r\n  opacity: 0;\r\n  transition: all 0.2s ease-out 0s;\r\n}\r\n\r\n/*** Main nav area ***/\r\n\r\n.rightNav {\r\n  height: 100%;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: flex-end;\r\n  /* background-color: green; */\r\n  padding-left: 20px;\r\n}\r\n\r\n/*** Search bar ***/\r\n\r\n.searchBar {\r\n  height: 65%;\r\n  display: flex;\r\n  align-items: center;\r\n  position: relative;\r\n}\r\n\r\n.searchBar input {\r\n  height: 100%;\r\n  width: 200px;\r\n  border-radius: 25px;\r\n  padding-left: 20px;\r\n  padding-right: 45px;\r\n  border: #e2e2e2 1px solid;\r\n  font-size: 16px;\r\n  box-sizing: border-box;\r\n  font-family: \"ProductSansRegular\", sans-serif;\r\n  transition: all 0.4s ease-in-out 0s;\r\n}\r\n\r\n.searchBar input:focus {\r\n  width: 400px;\r\n  border: #92b1ff 2px solid;\r\n  transition: all 0.4s ease-in-out 0s;\r\n}\r\n\r\n.searchBar input::-webkit-input-placeholder {\r\n  color: #afafaf;\r\n}\r\n\r\n.searchBar input::-ms-input-placeholder {\r\n  color: #afafaf;\r\n}\r\n\r\n.searchBar input::placeholder {\r\n  color: #afafaf;\r\n}\r\n\r\n.searchBar i {\r\n  color: #e2e2e2;\r\n  position: absolute;\r\n  right: 0;\r\n  padding-right: 20px;\r\n  cursor: pointer;\r\n  transition: all 0.2s ease-in-out 0s;\r\n  visibility: visible;\r\n  opacity: 1;\r\n}\r\n\r\n.textPresent {\r\n  visibility: hidden !important;\r\n  opacity: 0 !important;\r\n  transition: all 0.2s ease-in-out 0s;\r\n}\r\n\r\n.profileInformation {\r\n  margin-left: 30px;\r\n  margin-right: 20px;\r\n  display: flex;\r\n  align-items: center;\r\n}\r\n\r\n.username {\r\n  margin-right: 10px;\r\n  cursor: pointer;\r\n}\r\n\r\n.profileIcon {\r\n  height: 40px;\r\n  width: 40px;\r\n  border-radius: 50%;\r\n  margin-right: 20px;\r\n  cursor: pointer;\r\n  background-color: #fff;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n}\r\n\r\n.profileIcon i {\r\n  font-size: 40px;\r\n  color: rgb(110, 110, 110);\r\n}\r\n\r\na {\r\n  text-decoration: none;\r\n  color: inherit;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authService, router, sidenav, userService) {
        this.authService = authService;
        this.router = router;
    ...
    NavbarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _sidenav_sidenav_service__WEBPACK_IMPORTED_MODULE_2__["SidenavService"], _services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"]])
    ], NavbarComponent);
...
module.exports = "/*** History ***/\r\n.history {\r\n  min-height: calc(100vh - 60px);\r\n  width: 100%;\r\n  overflow: hidden;\r\n}\r\n.wrapper {\r\n  width: 1350px;\r\n  min-height: 100%;\r\n  margin: auto;\r\n}\r\n.wrapper h1 {\r\n  font-size: 50px;\r\n  margin-top: 40px;\r\n  margin-bottom: 10px;\r\n}\r\n/*** Search area ***/\r\n.searchArea {\r\n  margin: auto;\r\n  width: 100%;\r\n  padding: 20px 0px;\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  justify-content: center;\r\n}\r\n.searchItem {\r\n  padding: 7px 12px;\r\n  margin: 5px 7px;\r\n  font-size: 14px;\r\n  border-radius: 25px;\r\n  font-weight: 500;\r\n  cursor: default;\r\n  background-color: #f1eff4;\r\n}\r\n.searchItem:hover {\r\n  text-decoration: underline;\r\n}\r\n.searchItem i {\r\n  margin-left: 5px;\r\n  cursor: pointer;\r\n}\r\n/*** History area ***/\r\n.historyArea {\r\n  margin-top: 20px;\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  justify-content: center;\r\n}\r\n.historyTile {\r\n  padding: 10px;\r\n  margin: 10px;\r\n  width: 175px;\r\n}\r\n.historyImage {\r\n  width: 175px;\r\n  height: 175px;\r\n  border-radius: 25px;\r\n  background-color: #f1eff4;\r\n  position: relative;\r\n  cursor: pointer;\r\n}\r\n.historyImage img {\r\n  height: 100%;\r\n  width: 100%;\r\n  -o-object-fit: cover;\r\n     object-fit: cover;\r\n  border-radius: 25px;\r\n}\r\n.hidden {\r\n  visibility: hidden;\r\n}\r\n.historyOverlay {\r\n  width: 100%;\r\n  height: 100%;\r\n  background-color: rgba(39, 39, 39, 0.2);\r\n  opacity: 0;\r\n  transition: all 0.3s ease-in-out 0s;\r\n  position: absolute;\r\n  z-index: 10;\r\n  top: 0;\r\n  left: 0;\r\n  border-radius: 25px;\r\n}\r\n.historyImage:hover .historyOverlay {\r\n  transition: all 0.3s ease-in-out 0s;\r\n  opacity: 1;\r\n}\r\n.historyInfo {\r\n  padding-top: 5px;\r\n  font-size: 10pt;\r\n  text-align: left;\r\n  font-family: \"ProductSansRegular\", sans-serif;\r\n  width: 90%;\r\n  margin: auto;\r\n}\r\n.historyInfo h3:hover {\r\n  text-decoration: underline;\r\n  cursor: pointer;\r\n}\r\n/*** General elements ***/\r\n.breakLine {\r\n  width: 100%;\r\n  height: 2px;\r\n  background-color: #eaeaea;\r\n  border-radius: 25px;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm5/platform-browser.js");
/* harmony import */ var _recipe_dialog_recipe_dialog_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../recipe-dialog/recipe-dialog.service */ "./src/app/components/recipe-dialog/recipe-dialog.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SavedRecipesComponent = /** @class */ (function () {
    function SavedRecipesComponent(recipeService, userService, cookbookService, router, title, recipeDialog) {
        this.recipeService = recipeService;
        this.userService = userService;
        this.cookbookService = cookbookService;
        this.router = router;
    ...
    SavedRecipesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_recipe_service__WEBPACK_IMPORTED_MODULE_1__["RecipeService"], _services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _services_cookbook_service__WEBPACK_IMPORTED_MODULE_3__["CookbookService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__["Title"], _recipe_dialog_recipe_dialog_service__WEBPACK_IMPORTED_MODULE_6__["RecipeDialogService"]])
...
var GeneralService = /** @class */ (function () {
    ...
    GeneralService.prototype.getDashPhrase = function () {
        var phrase = "Welcome back Thomas";
        return phrase;
    };
...
var RecipeValidateService = /** @class */ (function () {
    function RecipeValidateService(userService, recipeService, http) {
        this.userService = userService;
        this.recipeService = recipeService;
        this.http = http;
        this.saveLock = false;
    ...
    RecipeValidateService.prototype.toggleSave = function (data, recipe) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](function (o) {
            if (!_this.saveLock) {
                _this.saveLock = true;
                var userData = { id: JSON.parse(localStorage.getItem("user")).id, data: data.recipes };
    ...
    RecipeValidateService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"], _recipe_service__WEBPACK_IMPORTED_MODULE_2__["RecipeService"], _angular_http__WEBPACK_IMPORTED_MODULE_4__["Http"]])
